...
const FieldDetailsFull = ({ fieldData }) => {
  return (
    <section className='flex flex-col gap-4 h-full w-full max-w-screen-lg'>
        <div className="min-h-[90vh] flex rounded-xl bg-gray-300/50 p-4 w-full h-full flex-col mt-5">
        ...
        <div className="flex rounded-xl bg-gray-300/50 p-4 w-full flex-col">
